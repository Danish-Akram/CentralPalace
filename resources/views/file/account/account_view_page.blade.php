...
<div style="width: 700px;background:#dfe6e9; margin-top:30px" class="center">
    <header><i class="fa fa-home" aria-hidden="true"></i> / Account Maintenance / View Form</header>
...
<div class="row" style="">
   <span>
<label  > Code : </label>
<input  type="text" name="code" id="account_code" value="{{$account->code}}" class="form-control" maxlength="10" onkeyup="autoMove(this,'status')" autofocus pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}" title="00-00-0000" readonly>
</span>
<span>
    <label style="margin-left: 42px">STATUS : </label>
<select name="status" id="status" style="height:25px;" class="form-control" onkeyup="autoMove(this,'description')" disabled>
...
<input  type="text" name="description"value="{{$account->description}}" id="description"  class="form-control " size="60" value="" maxlength = "40" onkeyup="autoMove(this,'urdu_description')" readonly>
</div>
<div id="description_error"></div>
{{-- <div class="row">
    <label class="urdu" > وضاخت : </label>
    <input  type="text" name="urdu_description" value="{{$data->urdu_description}}" id="urdu_description" class="form-control urdu" size="32" value="" maxlength = "255" onkeyup="autoMove(this,'email')" readonly>
    </div> --}}
<div class="row">
<label  > Email : </label>
<input  type="email" name="email" class="form-control" id="email"  value="{{$account->email}}" size="60" maxlength = "40" onkeyup="autoMove(this,'mobile')" style="text-transform: lowercase !important" readonly>
</div>
<div class="row">
    <label  > Mobile : </label>
    <input  type="text" name="mobile" value="{{$account->mobile}}" class="form-control" id="mobile"  value=""  maxlength = "11" onkeyup="autoMove(this,'debit_amount')" onkeypress='validate(event)' readonly>
    </div>
<div>
    <span>
        <label for=""> Debit Amount :</label>
        <input type="text" name="debit_amount" value=" {{$account->debit_amount}}" placeholder="0.00"  maxlength="12" id="debit_amount" class="form-control right format" onkeyup="autoMove(this,'credit_amount')" onkeypress='validate(event)' readonly>
    </span>
    <span>
        <label for=""> Credit Amount :</label>
        <input type="text" name="credit_amount" value=" {{$account->credit_amount}}" placeholder="0.00" id="credit_amount" maxlength = "12" class="form-control right format" onkeyup="autoMove(this,'ntn')" onkeypress='validate(event)' readonly>
    </span>
</div>
{{-- <hr class="style2 ">
...
<div class="row">
<label  > NTN : </label>
<input  type="text" name="ntn" value=" {{$data->ntn}}" class="form-control " id="ntn" maxlength = "20" value="" onkeyup="autoMove(this,'strn')" onkeypress='validate(event)' readonly>
</div>
<div>
<label  > STRN : </label>
<input  type="text" name="strn" value=" {{$data->strn}}" class="form-control " maxlength = "20" id="strn"   onkeyup="autoMove(this,'nic')" onkeypress='validate(event)' readonly>
</div>
<div>
<label  > NIC : </label>
<input  type="text" name="nic" value=" {{$data->nic}}" class="form-control" maxlength = "13" id="nic" onkeypress='validate(event)' onkeyup="autoMove(this,'submit')" readonly>
</div> --}}
<hr class="style1">
...
//         if (e.keyCode == 32) {
//             $('#code_error').text("Space not allowed!").addClass("alert");
//             e.preventDefault();
//         }else{
//             $('#code_error').text("");
//         }
...
//             $('#code_error').text("Please fill out this field.").addClass("alert");
...
//         if(_control == 00) { //control+"-00-0000"
//         // alert("")
//         $('#code_error').text("Invalid Control Code.").addClass("alert");
//         $('#account_code').css('border', 'thin solid red'); 
//         $("#account_code").click(function(){
//             $("#account_code").removeAttr("style");
//             $('#account_code').addClass('form-control');
...
//         $('#code_error').text("Invalid Sub Control Code.").addClass("alert");
//         $('#account_code').css('border', 'thin solid red'); 
//         $("#account_code").click(function(){
//             $("#account_code").removeAttr("style");
//             $('#account_code').addClass('form-control');
...
//                     if(response == 'exist'){
//                         $('#status').removeClass('form-control');
//                         $('#code_error').text("Code already exist").addClass("alert");
//                         $('#account_code').css('border', 'thin solid red'); 
//                         $("#account_code").click(function(){
//                         $("#account_code").removeAttr("style");
//                         $('#account_code').addClass('form-control');
