...
<div class="row">
<label  > Name : </label>
<input  type="text" name="name" tabindex="3" value="{{ $customer->tcstnam }}" id="name" class="form-control " size="60" value="" maxlength = "40" onkeyup="autoMove(this,'urdu_description')">
</div>
<div id="description_error"></div>

    <div>
        <label> Address 1 :</label>
        <input  type="text" name="address1" value="{{ $customer->tcstadd1 }}" tabindex="4" class="form-control"  maxLength="40" size="60"value="">
    </div>
    <div>
        <span>
            <label> Address 2 :</label>
            <input  type="text" name="address2" value="{{ $customer->tcstadd2 }}" tabindex="5" class="form-control"  maxLength="40" size="60"value="">    
        </span>
    </div>
    <div>
        <label  > NIC : </label>
        <input  type="text" name="nic" id="nic" value="{{ $customer->tcstnic }}" tabindex="6" class="form-control" maxlength = "15" size= "" onkeypress='validate(event)' onkeyup="autoMove(this,'submit')">
        </div> 
    <div class="row">
        <label  > Mobile : </label>
        <input  type="text" name="mobile" value="{{ $customer->tphnnum }}" tabindex="7" class="form-control" id="mobile"  value="" size= ""  maxlength = "11" onkeyup="autoMove(this,'debit_amount')" onkeypress='validate(event)'>
        </div>
        <div class="row">
            <label  > Email : </label>
            <input  type="email" name="email" value="{{ $customer->tcstema }}" class="form-control" tabindex="8" id="email"  value="" size="60" maxlength = "40" onkeyup="autoMove(this,'mobile')" style="text-transform: lowercase !important">
            </div>
