...
<div style="">
<form action="{{ route('employee_insert_data') }}" method="post" enctype="multipart/form-data" autocomplete="off">
{{csrf_field()}}
<div>
<span>
<label for="code"> Code :</label>
<input  type="text" id="code" name="code" class="form-control" size= "7" value="{{ str_pad($employee, 3, '0', STR_PAD_LEFT) }}" readonly>
</span>
...
<button type="button" class="button" tabindex="5" onclick="window.location='{{route('employee')}}'">Return</button>
</div>
</form>
</div>
</div>
