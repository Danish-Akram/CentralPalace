...
<div style="">
<form action="{{route('function_update_data', $function->id)}}" method="post" enctype="multipart/form-data" autocomplete="off">
{{csrf_field()}}
<div>
<span>
...
<input  type="text" id="description" name="description" value="{{ $function->description }}" class="form-control" size="60" maxlength="40" tabindex="1" autofocus>
</div>
