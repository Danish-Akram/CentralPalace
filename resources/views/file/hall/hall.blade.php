...
<div  style="margin-top:30px; width:900px;" class="center">
  <header><i class="fa fa-home" aria-hidden="true"></i> / Hall Maintenance</header>
  <div>
  <a href="{{route('home')}}" class="button">home</a>
  <a href="{{route('hall_insert_btn')}}" class="button">add new</a>
  ...
  <table class="table" id= "myTable">
    ...
    @endif
      ...
      @endif      
        ...
        <td class=""><a href="{{route('hall_update_page',$_data->id)}}">  <i class="far fa-edit"></i></a>
      <a href="{{route('hall_view_page',$_data->id)}}"><i class="fas fa-eye"></i></a>
    </td>
      </tr>
      @endforeach
    </tbody>
