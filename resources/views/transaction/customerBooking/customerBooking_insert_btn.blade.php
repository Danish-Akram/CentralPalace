...
@endphp
      <div style="width: 1000px;margin-top:30px; background:#dfe6e9" class="center">
        <header><i class="fa fa-home" aria-hidden="true"></i> / Customer Booking Maintenance / Insert Form</header>
        <div>
        <form action="{{route('customerBooking_insert_data')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
        {{csrf_field()}}
        ...
        <div>
            ...
            <span  >
                ...
                <input type="date" name="eventDate" size="10"  class="form-control" id="" style="width: 130px !important"  value="{{ date('Y-m-d') }}">
            </span>
        </div>
        <div>
            <span>
            ...
            <span >
              ...
              <span>
                ...
                <input  type="text" name="perHead" size="10" class="form-control right format perHead" value="" onkeypress='validate(event)'>
            </span>
        </div>
        <div>
            <span>
        ...
        <span style="height: 190px; width:680px;display:inline-block; margin:none !important; overflow-y:scroll">
          ...
          <span style="float: right; width:320px;">
                        <span class="row">
                            ...
                            <input  type="text" name="hallChg" class="form-control right format hallChg"  value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style="width:40% !important;"> AC Charges:</label>
                            <input  type="text" name="acChg"  class="form-control right format acChg" value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style=" width:40% !important;"> Decore Charges :</label>
                            <input  type="text" name="decorChg"  class="form-control right format decorChg"   value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style="width:40% !important;"> DJ Charges :</label>
                            <input  type="text" name="djChg"  class="form-control right format djChg"   value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style="width:40% !important;"> Heating Charges :</label>
                            <input  type="text" name="haetingChg"  class="form-control right format heatingChg"  value="" onkeypress='validate(event)'>
                        </span>
                        <hr class="style2">
                        <span class="row">
                            <label style="width:40% !important;"> Total Amount :</label>
                            <input  type="text"name="totalAmt"  class="form-control right format totalAmt"   value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style="width:40% !important;">Advance :</label>
                            <input  type="text" name="advance"  class="form-control right format advAmt"   value="" onkeypress='validate(event)'>
                        </span>
                        <span class="row">
                            <label style="width:40% !important;"> Balance :</label>
                            <input  type="text" name="balance"  class="form-control right format balance"   value="" onkeypress='validate(event)'>
                        </span>
            </span>
        </div>
